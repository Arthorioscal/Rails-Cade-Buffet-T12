...
describe 'Client makes an order' do
    ...
    it 'and must fill in all fields except adress' do
        user = User.create!(email: 'raiden@mgs.com', password: 'solidsnakefan', role: :buffet_owner)
        buffet = Buffet.create!(brand_name: 'Buffet do Snake', corporate_name: 'Buffet do Snake Ltda', cnpj: '45195101000101',
        phone: '11999999999', email: 'solidsnakefans@mail.com', address: 'Rua do Buffet, 123', neighborhood: 'Bairro do Buffet',
        state: 'São Paulo', city: 'São Paulo', zip_code: '12345678', description: 'Buffet especializado em festas de aniversário',
        ...
        click_on 'Festa de Aniversário'
        click_on 'Realizar Pedido'
        fill_in 'Endereço do Evento', with: 'tanto faz'
        click_on 'Enviar Pedido'

        expect(page).to have_content('Data do Evento Informe a data do evento')
        expect(page).to have_content('Número de Convidados Estimado Informe o número de convidados')
        expect(page).to have_content('Detalhes do Evento Informe os detalhes do evento')
        expect(page).to have_content('Número de Convidados Estimado Informe um número válido')
    end

    it 'doenst fill the address0' do
        user = User.create!(email: 'raiden@mgs.com', password: 'solidsnakefan', role: :buffet_owner)
        buffet = Buffet.create!(brand_name: 'Buffet do Snake', corporate_name: 'Buffet do Snake Ltda', cnpj: '45195101000101',
        phone: '11999999999', email: 'solidsnakefans@mail.com', address: 'Rua do Buffet, 123', neighborhood: 'Bairro do Buffet',
        state: 'São Paulo', city: 'São Paulo', zip_code: '12345678', description: 'Buffet especializado em festas de aniversário',
        ...
        expect(page).to have_content('Endereço do Evento adicione informações no campo')
    end
    ...
    it 'and must be logged in as a client' do
        user = User.create!(email: 'raiden@mgs.com', password: 'solidsnakefan', role: :buffet_owner)
        buffet = Buffet.create!(brand_name: 'Buffet do Snake', corporate_name: 'Buffet do Snake Ltda', cnpj: '45195101000101',
        phone: '11999999999', email: 'solidsnakefans@mail.com', address: 'Rua do Buffet, 123', neighborhood: 'Bairro do Buffet',
        state: 'São Paulo', city: 'São Paulo', zip_code: '12345678', description: 'Buffet especializado em festas de aniversário',
        ...
        expect(page).not_to have_content('Realizar Pedido')
    end
end