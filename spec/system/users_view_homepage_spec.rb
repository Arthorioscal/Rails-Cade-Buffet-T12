...
describe 'Users view homepage', type: :system do
    it 'shows the homepage without any authentication' do
        ...
        Buffet.create!(brand_name: 'Buffet do Raiden', corporate_name: 'Buffet do Raiden Ltda', cnpj: '13877871000130',
        ...
        Buffet.create!(brand_name: 'Outer Heaven Catering', corporate_name: 'Outer Heaven Events Ltda', cnpj: '78719763000184',
        ...
        Buffet.create!(brand_name: 'Diamond Dogs Banquets', corporate_name: 'Diamond Dogs Culinary Services Ltda', cnpj: '92406600000172',
    ...
    it 'and sees all buffets' do
        ...
        expect(page).to have_content('Outer Heaven Catering')
        expect(page).to have_content('Diamond Dogs Banquets')
    end
end