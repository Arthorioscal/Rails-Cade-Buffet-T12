...
RSpec.describe Event, type: :model do
    context 'validations' do
        ...
        it 'min_people cannot be zero' do
            ...
            expect(event.errors.full_messages).to include( 'Quantidade mínima de pessoas não pode ser zero' )
        end
        ...
        it 'max_people cannot be zero' do
            ...
            expect(event.errors.full_messages).to include( 'Quantidade máxima de pessoas não pode ser zero' )
        end
    end
end
