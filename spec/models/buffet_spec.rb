    ...
    describe '#valid?' do
        context 'presence' do
            it 'false when brand_name is blank' do
                ...
                buffet = Buffet.new(brand_name: '', corporate_name: 'Buffet do Snake Ltda', cnpj: '89032028000114',
            ...
            it 'false when corporate_name is blank' do
                user = User.create!(email: 'raiden@mgs.com', password: 'solidsnakefan', role: :buffet_owner)
                buffet = Buffet.new(brand_name: 'Buffet do Snake', corporate_name: '', cnpj: '89032028000114',
                phone: '11999999999', email: 'solidsnakefans@mail.com', address: 'Rua do Buffet, 123', neighborhood: 'Bairro do Buffet',
                state: 'São Paulo', city: 'São Paulo', zip_code: '12345678', description: 'Buffet especializado em festas de aniversário',
                payment_methods: 'Dinheiro, cartão de crédito e débito', user: user)
                expect(buffet.valid?).to be_falsey
            ...
            it 'false when phone is blank' do
                user = User.create(email: 'raiden@mgs.com', password: 'solidsnakefan', role: :buffet_owner)
                buffet = Buffet.new(brand_name: 'Buffet do Snake', corporate_name: 'Buffet do Snake Ltda', cnpj: '89032028000114',
        ...
        context 'uniqueness' do
            it 'false when cnpj is not unique' do
                ...
                Buffet.create!(brand_name: 'Buffet do Snake', corporate_name: 'Buffet Metal Gear Ltda', cnpj: '89032028000114',
                phone: '11999999999', email: 'solidsnakefans@mail.com', address: 'Rua do Buffet, 123', neighborhood: 'Bairro do Buffet',
                state: 'São Paulo', city: 'São Paulo', zip_code: '12345678', description: 'Buffet especializado em festas de aniversário',
                payment_methods: 'Dinheiro, cartão de crédito e débito', user: user)
                buffet2 = Buffet.new(brand_name: 'Buffet do Raiden', corporate_name: 'Buffet do Raiden Ltda', cnpj: '89032028000114',
            ...
            it 'false when the user already has one buffet' do
                user = User.create!(email: 'raiden@mgs.com', password: 'solidsnakefan', role: :buffet_owner)
                Buffet.create!(brand_name: 'Buffet do Snake', corporate_name: 'Buffet Metal Gear Ltda', cnpj: '89032028000114',
                    phone: '11999999999', email: 'solidsnakefans@mail.com', address: 'Rua do Buffet, 123', neighborhood: 'Bairro do Buffet',
                    state: 'São Paulo', city: 'São Paulo', zip_code: '12345678', description: 'Buffet especializado em festas de aniversário',
        ...
        context 'cnpj' do
            it 'false when cnpj is invalid' do
                user = User.create!(email: 'raiden@mgs.com', password: 'solidsnakefan', role: :buffet_owner)
                buffet = Buffet.new(brand_name: 'Buffet do Snake', corporate_name: 'Buffet do Snake', cnpj: '1234567890123',
                phone: '11999999999', email: 'buffetrainde@mail.com', address: 'Rua do Buffet, 123', neighborhood: 'Bairro do Buffet',
                state: 'São Paulo', city: 'São Paulo', zip_code: '12345678', description: 'Buffet especializado em festas de aniversário',
                payment_methods: 'Dinheiro, cartão de crédito e débito', user: user)
                expect(buffet.valid?).to be_falsey
            end
